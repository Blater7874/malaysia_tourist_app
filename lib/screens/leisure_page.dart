...
class LeisurePage extends StatelessWidget {
  ...
  final List<String> educationalPlaces = [
    'images/perdana_botanical.png', // Changed from images/ to assets/
    'images/aquaria_klcc.png',
    'images/kl_park.png',
    'images/hou_temple.png',
    'images/klcc_park.png',
  ];

  LeisurePage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Leisure Places"),
